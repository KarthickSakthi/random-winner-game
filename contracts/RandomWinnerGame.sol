...
/**
join Game is called when a player wants to enter the game
*/
function joinGame() public payable{
    ...
    // add senders to players list
    players.push(msg.sender);
    emit PlayerJoined(gameId, msg.sender);
    //if the player list full start the winner selection process
...
This function is overrided to act upon the random number generated by chainlink VRF proof
...
function fulfillRandomness(bytes32 requestId, uint256 randomness) internal virtual override{
    ...
    //send ether in the contract to winner
